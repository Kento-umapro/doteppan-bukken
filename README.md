...
### 重点エリアの緩和基準（2026-08-20更新）
物件探しの**重点7府県**（大阪府・京都府・滋賀県・愛知県・群馬県・埼玉県・千葉県）は候補を幅広く拾うため基準を緩和する:
- 坪数の下限を **17坪** まで許容（通常23坪。上限40坪は据置）
- 出店偏差値の掲載下限を **48** に緩和（通常50。ニアミスも掲載し、48〜50は「基準やや未満・要現地確認」と注記）
- 巡回もこの7府県は通常より広めに収集する

他エリアは通常基準（23〜40坪・偏差値50以上）のまま。
